<div>
    ...
    <div class="card card-light card-hover card-horizontal mb-4">
        <div class="tns-carousel-wrapper card-img-top card-img-hover"><a class="img-overlay" href="{{ route('fraud.show', $fraud->slug ) }}"></a>
          <div class="position-absolute start-0 top-0 pt-3 ps-3"><span class="d-table badge bg-info">{{ $fraud->category->name }}</span></div>
        ...
        <div class="card-body">
          <div class="d-flex align-items-center justify-content-between pb-1"><span class="fs-sm text-light me-3"> publié il à {{ $fraud->created_at->diffForHumans() }}</span>
          ...
          <h3 class="h6 mb-1"><a class="nav-link-light" href="car-finder-single.html">{{ $fraud->name }}</a></h3>
